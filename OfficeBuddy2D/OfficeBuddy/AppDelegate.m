...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    sideMenuVC.centerViewController = centerVC;
    UINavigationController *sideMenuNav = [[UINavigationController alloc]initWithRootViewController:sideMenuVC];
    
    ContainerViewController *containerViewController = [[ContainerViewController alloc]initWithSideMenu:sideMenuNav center:centerNav];
